    ...
    <section>
      <Container className={`container-profissionais ${show ? "container-profissionais-active" : ""}`}>
        <Card className="card-lista-profissionais">
          <Card.Body>
            <Row>
              <Card.Title className="font-bold">Lista de Usuários</Card.Title>
            </Row>
            <Row className="mt-4">
              <Col lg={12} className="busca">
                ...
                <Button className="button-cadastro-profissional mt-3" as={Link} to="/usuarios/CadastrarUsuarios">
                  <CiCirclePlus /> Cadastrar Usuário
                </Button>
              </Col>
            </Row>
            <Row>
