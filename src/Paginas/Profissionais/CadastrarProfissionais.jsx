...
import styles from "./CadastrarProfissional.module.css"; // Importando o CSS como módulo
...
function CadastrarProfissionais() {
  ...
  return (
    <Container className={`${styles.containerProfissionais} ${show ? styles.containerProfissionaisActive : ""}`}>
      ...
      <form className={styles.formContainer} onSubmit={handleSubmit}>
        ...
        {erros.Nome_Completo && <p className={styles.erros}>{erros.Nome_Completo}</p>}
        ...
        <div className={styles.row}>
          <div className={styles.formGroup}>
            ...
            {erros.Data_Nascimento && <p className={styles.erros}>{erros.Data_Nascimento}</p>}
          </div>
        </div>
        ...
        <div className={styles.row}>
          <div className={styles.formGroup}>
            ...
            {erros.RG && <p className={styles.erros}>{erros.RG}</p>}
          </div>
        </div>
        ...
        <div className={styles.row}>
          <div className={styles.formGroup}>
            ...
            {erros.CPF && <p className={styles.erros}>{erros.CPF}</p>}
          </div>
        </div>
        ...
        {erros.registroProfissional && <p className={styles.erros}>{erros.registroProfissional}</p>}

        <h2>Acesso ao Sistema</h2>
        <label htmlFor="Senha">Senha:</label>
        <input type="password" id="Senha" name="Senha" value={usuario.Senha} onChange={handleUsuarioChange} />
        {erros.Senha && <p className={styles.erros}>{erros.Senha}</p>}
        ...
        {erros.form && <p className={`${styles.erros} text-danger mt-3`}>{erros.form}</p>}
